...
const faqs = [
  {
    ...
    a: "간단한 랜딩 페이지 기준으로는 수백만 원 이하에서 시작할 수 있고, 자동화/커스텀 기능이 늘어날수록 범위와 예산이 함께 커집니다. 현재 상황과 목표를 듣고, 현실적인 옵션을 함께 잡아드립니다.",
  },
  {
    q: "기존에 있는 웹사이트를 리뉴얼하는 것도 가능한가요?",
    a: "네, 기존 WordPress / Wix / 카페24 / 기타 커스텀 사이트에서 마이그레이션/리뉴얼 경험이 있습니다. 유지보수 비용이나 속도, 구조를 고려해서 방향을 제안드립니다.",
  },
  {
